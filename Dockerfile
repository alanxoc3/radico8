...
COPY local-radio docker/stop_ffmpeg docker/headless_pico8 docker/docker_init_script docker/create_image docker/stream_to_youtube docker/stream_to_icecast /usr/bin/
